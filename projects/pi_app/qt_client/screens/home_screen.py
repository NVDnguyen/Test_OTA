...
def create_home_screen_widget():
    ...
    map_button = QPushButton("Product Map Search")
    map_button.setObjectName("checkout_button")  # Use the same style as 'View Cart / Checkout'
    map_button.setMinimumHeight(40)
    layout.addWidget(map_button, alignment=Qt.AlignCenter)
    
    return home_widget, view_cart_button, serial_output_area, login_button, map_button